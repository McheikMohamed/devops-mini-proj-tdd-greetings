...
test('greeting in different languages (fr)', () => {
  ...
  expect(greet(['Marie', 'AMY'], 'fr')).toBe('Bonjour, Marie. ET BONJOUR AMY !')
  expect(greet(['MARIE', 'AMY'], 'fr')).toBe('BONJOUR, MARIE ET AMY !')
  expect(greet(['Marie', 'Brian', 'AMY'], 'fr')).toBe('Bonjour, Marie et Brian. ET BONJOUR AMY !')
  expect(greet(['Marie', 'AMY', 'Brian'], 'fr')).toBe('Bonjour, Marie et Brian. ET BONJOUR AMY !')
  expect(greet(['Marie', 'BRIAN', 'AMY'], 'fr')).toBe('Bonjour, Marie. ET BONJOUR BRIAN ET AMY !')
  expect(greet(['MARIE', 'BRIAN', 'AMY'], 'fr')).toBe('BONJOUR, MARIE, BRIAN ET AMY !')
})
...
test('greeting in different languages (en)', () => {
  ...
  expect(greet(['MARIE', 'AMY'], 'en')).toBe('HELLO, MARIE AND AMY !')
  expect(greet(['Marie', 'Brian', 'AMY'], 'en')).toBe('Hello, Marie and Brian. AND HELLO AMY !')
  expect(greet(['Marie', 'AMY', 'Brian'], 'en')).toBe('Hello, Marie and Brian. AND HELLO AMY !')
  expect(greet(['Marie', 'BRIAN', 'AMY'], 'en')).toBe('Hello, Marie. AND HELLO BRIAN AND AMY !')
  expect(greet(['MARIE', 'BRIAN', 'AMY'], 'en')).toBe('HELLO, MARIE, BRIAN AND AMY !')
})
...
test('greeting in different languages (nl)', () => {
  ...
  expect(greet(['MARIE', 'AMY'], 'nl')).toBe('HALLO, MARIE EN AMY !')
  expect(greet(['Marie', 'Brian', 'AMY'], 'nl')).toBe('Hallo, Marie en Brian. EN HALLO AMY !')
  expect(greet(['Marie', 'AMY', 'Brian'], 'nl')).toBe('Hallo, Marie en Brian. EN HALLO AMY !')
  expect(greet(['Marie', 'BRIAN', 'AMY'], 'nl')).toBe('Hallo, Marie. EN HALLO BRIAN EN AMY !')
  expect(greet(['MARIE', 'BRIAN', 'AMY'], 'nl')).toBe('HALLO, MARIE, BRIAN EN AMY !')
})
