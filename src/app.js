        ...
        for (let i = 0, j = 0, k = 0; i < name.length; i++) {
            ...
            if (name[i] === name[i].toUpperCase()) {
                if (upperNames === 1) retourPart2 += " " + name[i] + " !";
                    ...
                    else if (j === upperNames && language === 'fr') retourPart2 += " ET " + name[i] + " !";
                    else if (j === upperNames && language === 'nl') retourPart2 += " EN " + name[i] + " !";
                    else if (j === upperNames) retourPart2 += " AND " + name[i] + " !";
            ...
            //Other case names part
                ...
                if (lowerNames === 1) retourPart1 += ", " + name[i] + ".";
                    ...
                    k++;
                    if (k === lowerNames && language === 'fr') retourPart1 += " et " + name[i] + ".";
                    else if (k === lowerNames && language === 'nl') retourPart1 += " en " + name[i] + ".";
                    else if (k === lowerNames) retourPart1 += " and " + name[i] + ".";
